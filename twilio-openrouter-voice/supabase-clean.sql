-- Daily Briefing System - Clean SQL for Supabase
-- ===============================================
-- Run this SQL in Supabase SQL Editor (no syntax errors)
...
DROP POLICY IF EXISTS "Allow all operations on user_bills_subscriptions" ON public.user_bills_subscriptions;
CREATE POLICY "Allow all operations on user_bills_subscriptions" ON public.user_bills_subscriptions
    FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all operations on daily_briefing_status" ON public.daily_briefing_status;
CREATE POLICY "Allow all operations on daily_briefing_status" ON public.daily_briefing_status
    FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all operations on user_briefing_preferences" ON public.user_briefing_preferences;
...
-- 8. Insert sample briefing preferences
...
-- 9. Utility function to calculate next due date
...
-- 10. Function to get bills due within N days
